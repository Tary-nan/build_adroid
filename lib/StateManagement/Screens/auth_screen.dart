                ...
                children: <Widget>[
                  Flexible(
                    child: Container(
                      ...
                      transform: Matrix4.rotationZ(-8 * pi / 180) // pi / angle 180 -8 steps  aiguille d'une montre + =/= -
                        ..translate(-10.0),
                      // ..translate(-10.0),
                      decoration: BoxDecoration(
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Container(
        ...
        constraints:
            BoxConstraints(minHeight: _heightContainer.value.height),
