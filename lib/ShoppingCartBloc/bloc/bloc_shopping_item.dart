...
import 'package:buildadroid/ShoppingCartBloc/bloc/bloc_shopping_item_bloc.dart';
...
class _ShoppingItemWidgetState extends State<ShoppingItemWidget> {
  ...
  void _initBloc() {
    ...
    _subscription = _shoppingBloc.shoppingBasket.listen((cart){
      _bloc.shoppingBasket(cart);
    });
  }
